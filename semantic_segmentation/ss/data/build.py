...
NORMALIZATIONS = {
    'ugscnn':
        ([0.4974898, 0.47918808, 0.42809588, 1.0961773],
    ...
    'synthia':
        ([0.45120219, 0.42573797, 0.39205981],
...
def build_dataset(cfg, is_train=True):
    ...
    if cfg.DATASET == 'synthia':
        ...
        file_list = os.path.join(cfg.DATA_ROOT, 'data_lists',
                                 cfg.DATA_FORMAT,
        ...
        raise AttributeError(
            'Dataset {} is not implemented'.format(cfg.DATASET))
